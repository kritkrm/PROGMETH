...
public class LittleRetryButton extends Button {
	...
	public void draw(GraphicsContext gc) {
		...
		if( isInside( InputUtility.getMouseX(),InputUtility.getMouseY() ) ) {
			gc.drawImage( Resources.getInstance().littleRetryButton , 
			...
			gc.drawImage(Resources.getInstance().littleRetryButton, x, y, Constants.DEFAULT_LITTLE_BUTTON_SIZE.getWidth() , Constants.DEFAULT_LITTLE_BUTTON_SIZE.getHeight() );
		}
		gc.setGlobalAlpha(1);
